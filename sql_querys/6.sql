...
SELECT t1.PromotionKey, t1.total_uso_id_promo AS total_uso_promo, promo.SpanishPromotionName, promo.SpanishPromotionType Tipo, promo.SpanishPromotionCategory Categoria
FROM tabla1 t1
