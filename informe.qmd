...
q10b %>% 
  ...
  geom_point() +
  ggtitle("Resellers: volumen de venta vs volumen de unidades vendidas") +
  theme_minimal()
```

##### Visualización 14

En la siguiente visualización se observa que existen resellers que se destacan al comparar el total de unidades vendidas con el total de productos vendidos (teniendo en cuenta que 1 producto = 1 nombre de producto). Sería de interés
