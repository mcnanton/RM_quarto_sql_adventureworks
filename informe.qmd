...
author: "María Nanton, Magalí Rodríguez Pires"
format:
  pdf:
    toc: false
...
##### Visualización 8
Se observa que la distribución de promociones aplicadas es muy asimétrica: el descuento por volumen es el más aplicado. Sería de interés explorar un esquema más flexible de promociones para ofrecer más opciones más allá de la venta por volumen o el descuento en la ocasión del lanzamiento de un nuevo producto.
